...
<body>
    ...
    <div class="sidebar p-3" id="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#modalImport"
                    onclick="closeSidebarOnMobile()">
                    <i class="fas fa-file-import me-2"></i> Import CSV
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#modalFoto"
                    onclick="closeSidebarOnMobile()">
                    <i class="fas fa-camera me-2"></i> Foto Kelas
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="{{ route('admin.foto_kenangan.index') }}"
                    class="nav-link {{ request()->routeIs('admin.foto_kenangan.*') ? 'active' : '' }}">
